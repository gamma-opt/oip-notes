...
We have seen in [](lecture01.md) that the gradient $\nabla f(x_0)$ describes the direction of steepest ascent at some point $x_0$.
A consequence of this is that the negative gradient $-\nabla f(x_0)$ corresponds to the direction of the steepest descent at $x_0$.

::: {.callout-note title="Why? Linearity of Differentiation" collapse=true}
...
which means that the direction of steepest ascent for a function $f$ must necessarily be the direction of steepest descent for $-f$.
:::
...
Consider the second-order approximation of $f$ at $x_k$, which is given by
$$
